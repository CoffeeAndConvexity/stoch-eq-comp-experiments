...
def plot(path_, algorithm_set, y_min=None, seeds=None):
    ...
    fig.savefig(f"{save_path}/sim-data-linear-{'+'.join(algorithm_set)}.png", bbox_inches='tight', pad_inches=0.02)
    plt.close(fig)


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Plot the synthetic linear-utility experiment.')
    parser.add_argument('--path', default='sim-data-linear', help='directory name below data/ and plots/')
